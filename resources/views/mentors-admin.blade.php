...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3 d-flex justify-content-between align-items-center">
                            <h6 class="m-0 font-weight-bold text-primary">Mentors Data</h6>
                    
                            <a href="#" class="btn btn-success btn-icon-split" data-toggle="modal" data-target="#addMentorModal">
                                <span class="icon text-white-50">
                                    <i class="fas fa-plus"></i>
                                </span>
                                <span class="text">Add Mentor</span>
                            </a>                                                   
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="#" 
                                                   ...
                                                   data-toggle="modal"
                                                   data-target="#editMentorModal{{ $mentor->id }}">
                                                    <span class="icon text-white-50">
                                                ...
                                                <a href="#" 
                                                    ...
                                                    data-toggle="modal"
                                                    data-target="#deleteMentorModal{{ $mentor->id }}">
                                                    <span class="icon text-white-50">
                ...
                <form action="{{ route('mentors-store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="phone_number" class="form-control" maxlength="13" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="d-flex">
                                <div class="custom-control custom-radio mr-4">
                                    <input type="radio" id="jenisEkonomi" name="jenis" value="ekonomi" class="custom-control-input" required>
                                    <label class="custom-control-label" for="jenisEkonomi">Ekonomi</label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="jenisBisnis" name="jenis" value="bisnis" class="custom-control-input">
                                    <label class="custom-control-label" for="jenisBisnis">Bisnis</label>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('mentors-update', $mentor->id) }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" name="name" value="{{ $mentor->name }}" class="form-control" required>
                        </div>
    
                        <div class="form-group">
                            <label>Email</label>
                            <input type="email" name="email" value="{{ $mentor->email }}" class="form-control" required>
                        </div>
    
                        <div class="form-group">
                            <label>Phone Number</label>
                            <input type="text" name="phone_number" value="{{ $mentor->phone_number }}" class="form-control" maxlength="13" required>
                        </div>
                        ...
                        <div class="form-group">
                            <label>Address</label>
                            <textarea name="address" class="form-control" required>{{ $mentor->address }}</textarea>
                        </div>
    ...
    <!-- DELETE MENTOR MODAL -->
    @foreach($mentors as $mentor)
    <div class="modal fade" id="deleteMentorModal{{ $mentor->id }}" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure want to delete <b>{{ $mentor->name }}</b> ?
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('mentors-delete', $mentor->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
