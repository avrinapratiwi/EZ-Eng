...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between align-items-center">
                            <h6 class="m-0 font-weight-bold text-primary">Question Data</h6>
                            <a href="#" class="btn btn-success btn-icon-split mb-3" data-toggle="modal" data-target="#addQuestionModal">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="#" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#editQuestion{{ $question->id }}">
                                                    Edit
                                                </a>
                                
                                                <a href="#" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteQuestion{{ $question->id }}">
                                                    Delete
                                                </a>
                                            </td>
                                        </tr>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('questions.store', $quiz->id) }}" method="POST">
                    @csrf
                    <input type="hidden" name="module_id" value="{{ $quiz->id }}">
                ...
                <form action="{{ route('questions.update', [$quiz->id, $question->id]) }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>Question</label>
                            <textarea 
                                name="question_text_edit" 
                                id="question_text_edit_{{ $question->id }}" 
    ...
    <div class="modal fade" id="deleteQuestion{{ $question->id }}">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="{{ route('questions.delete', [$quiz->id, $question->id]) }}" method="POST">
                        @csrf
                        @method('DELETE')
    ...
    <script>
        ...
        $('#addQuestionModal form').on('submit', function(e) {
    ...
    <script>
        let editEditors = {};
        document.querySelectorAll("[id^='question_text_edit_']").forEach(textarea => {
            ClassicEditor
                .create(textarea)
                .then(editor => {
                    editEditors[textarea.id] = editor;
                })
                .catch(error => console.error(error));
        });

        $("form").on("submit", function() {
            let id = $(this).find("textarea[id^='question_text_edit_']").attr("id");
            if (id && editEditors[id]) {
                editEditors[id].updateSourceElement();
            }
        });
    </script>
